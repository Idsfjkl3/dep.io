    ...
    if (oceanmusic && oceanskymusic) {
          ...
          if (me.x < canvas.width/2) {
            me.camx = canvas.width/2
              ...
              me.camx = Constants.MAP_SIZE_W - canvas.width/2
              } else {
              me.camx = me.x
              }
              ...
              if (me.y < canvas.height/2) {
                me.camy = canvas.height/2
                  ...
                  me.camy = Constants.MAP_SIZE_H - canvas.height/2
                  } else {
                  me.camy = me.y
                  }
                }
      ...
      case 18:
        ...
        case 19:
          ...
          exH = exY = 1.28235294118
            ...
            exW = exX = 1.33333333333
            exH = exY = 1.24156862745
          }
          break;
}
   var pulse = 1 - (Math.min(1, 1 - (player.pulsecd - Date.now())/1000)) * 0.15
...
function renderObject(me, bullet) {
  ...
  switch (bullet.type) {
    ...
    case 10:
      ...
      ctx.fillStyle = '#ECDC9A';
      ctx.translate(xx + w/2, yy + h/2)
      crePolygonV(bullet.vert, xx, yy)
      ctx.translate(-xx - w/2, -yy - h/2)
...
var terrain = ctx.createPattern(theImg, "repeat")
      ...
      ctx.drawImage(
        ...
        case 22:
          ...
          ctx.translate((canvasX), (canvasY))
          ctx.rotate(bullet.direction);
      var theImg = getAsset('bush.png')
      if (theImg) {
      ctx.drawImage(
        theImg,
        -bullet.radius,
        -bullet.radius * 121/197,
        bullet.radius * 2,
        bullet.radius * 2 * 121/197,
      );
    }
          ctx.rotate(-bullet.direction);
          ctx.translate(-(canvasX), -(canvasY))
